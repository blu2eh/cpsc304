...
function PantryTable() {
    ...
    const [pantries, setPantries] = useState([
        { id: 1, nickname: 'Brand 1'},
        { id: 2, nickname: 'Brand 2'},
    ]);
    ...
    const sendSelectionToBackend = async (pantryData) => {
        setSelectedPantry(pantryData);
        // Placeholder for backend call
        // You would replace this with your actual backend call, for example using fetch or axios
        console.log('Sending data to backend:', pantryData);
    ...
    const handleRowClick = (pantry) => {
        sendSelectionToBackend(pantry).then(r => 1);
    };
        ...
        <div style={styles.tableContainer}>
            <table style={styles.table}>
                ...
                {pantries.map((fridge) => {
                    ...
                    const rowStyle = fridge.id === selectedPantry ? styles.selectedRow : styles.td;
                    return (
