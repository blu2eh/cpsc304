...
// import "./htmlFoodDTableFunction2.css"
function FoodTable() {
    console.log('Refrigerator is rendering');
    // const [tableData, setTableData] = useState([
    //     {id: 1, foodName: 'Tree', foodType: 'Vegetable', nutrition:'5 calories', checked: false}
    // ])
    const initialTableData = Array.from({ length: 15 }, (_, index) => ({
        id: index + 1,
    ...
    const styles = {
        tableContainer: {
            display: 'flux',
            width: '600px', // Set the width of the table container
            maxHeight: '190px', // Set the maximum height of the table container
